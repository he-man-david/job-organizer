...
export const Jobs: Job[] = [
  { id: 1, name: "Apple", position: "Software Engineer II",
    progress: 10, applied: true, status: "Application Submitted" },
  ...
  { id: 4, name: "Baidu", position: "Data Developer II",
    progress: 45, applied: true, status: "1st Round Interview Done!" },
  { id: 5, name: "Facebook", position: "Software Engineer II",
    progress: 85, applied: true, status: "3rd Round Interview Done!" },
